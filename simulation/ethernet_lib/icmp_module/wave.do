...
add wave -noupdate /icmp_module_tb/ICMP_DAT_FILENAME
add wave -noupdate /icmp_module_tb/ICMP_LOG_FILENAME
add wave -noupdate /icmp_module_tb/ICMP_RX_READY_FILE
add wave -noupdate /icmp_module_tb/MNL_RST_FILE
add wave -noupdate -radix decimal -radixshowbase 0 /icmp_module_tb/simulation/counter
