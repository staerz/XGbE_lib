...
add wave -noupdate -radix hexadecimal -radixshowbase 0 /dhcp_module_tb/uut/dhcp_tx_packet_o
...
add wave -noupdate -expand -group internals /dhcp_module_tb/uut/blk_make_tx_interface/dhcp_data_loaded
add wave -noupdate -expand -group internals /dhcp_module_tb/uut/blk_make_tx_interface/config_tg_ip
add wave -noupdate -expand -group internals /dhcp_module_tb/uut/blk_make_tx_interface/config_tg_mac
add wave -noupdate -expand -group internals /dhcp_module_tb/uut/blk_make_tx_interface/fifo_state
add wave -noupdate -expand -group internals /dhcp_module_tb/uut/blk_make_tx_interface/tx_count
add wave -noupdate -expand -group internals /dhcp_module_tb/uut/blk_make_tx_interface/tx_state
